...
function generateLink($url, $lable, $class) /*function name*//*arguments*/
{
   /*function code*/
...
<body>
   ...
   <!------------------------------------------------>
   <!-- Goal 1.1 includes files (header) ------------>
   <!-- Goal 1.2 includes files (navigation boxes) -->
   <!-- Goal 1.3 includes files (footer) ------------>
   <!------------------------------------------------>
